...
contract RntCrowdsale is ICrowdSale, Pausable {
    ...
    */
    ...
    event MinimalInvestmentWasSet(uint256 _minimaInvestment);
    ...
    */
    ...
    /**
    @notice Check investment sum
    */
    modifier reachedMinimalInvestment(uint256 _userInvestment) {
        require(_userInvestment >= minimalInvestment);
        _;
    }
    ...
    */
    ...
    /**
    @notice Set minimum investment value
    @dev Could be called only from owner
    @param _minimalInvestment A new minimal investment restriction value
    */
    function setMinimalInvestment(uint256 _minimalInvestment) whenNotPaused onlyOwner public {
        minimalInvestment = _minimalInvestment;
        MinimalInvestmentWasSet(_minimalInvestment);
    }
    ...
    */
    ...
    @param _customerUuid (optional) UUID v4 to track the successful payments on the server side
    */
    function invest(bytes16 _customerUuid) whenNotPaused inStatus(Status.ICO) reachedMinimalInvestment(msg.value) public payable {
